...
\begin{figure}[H]
	...
	\caption{Showing the first 5 eigenmodes of each method. They are unstable. The spectral methods agree with theoretical eigenvalues.}
...
\begin{figure} [H]
	...
	\caption{Showing the first 5 eigenmodes, they are unstable. Two methods agree well on the first 3 modes, and start to have significant difference after that.}
...
\begin{figure} [H]
	...
	\caption{Unable to obtain meaningful results. The decelerating case might not be physically possible.}
